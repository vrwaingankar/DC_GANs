# USAGE
# python dcgan_cifar10.py --output output
# import the necessary packages
from Vinit.dcgan import Generator
from Vinit.dcgan import Discriminator
...
# load the EMNIST dataset and stack the training and testing data
# points so we have additional training data
print("[INFO] loading EMNIST dataset...")
trainData = EMNIST(root="data", train=True, download=True,
    split='letters',
	transform=dataTransforms)
testData = EMNIST(root="data", train=False, download=True,
    split='letters',
	transform=dataTransforms)
